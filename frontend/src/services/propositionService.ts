 ...
 */
export async function saveProposition(proposition: PropositionData): Promise<string> {
  try {
 ...
 */
export async function getPropositions(language: string = 'th'): Promise<PropositionData[]> {
  try {
    const response = await fetch(
      `${FUNCTIONS_URL}/propositions?language=${language}`,
      { method: 'GET' }
    );
 ...
 */
export async function getRandomProposition(language: string = 'th'): Promise<PropositionData | null> {
  try {
 ...
 */
export const SAMPLE_PROPOSITIONS_TH: PropositionData[] = [
  {
...
export const SAMPLE_PROPOSITIONS_EN: PropositionData[] = [
  {
 ...
 */
export async function initializeSamplePropositions(): Promise<void> {
  try {
